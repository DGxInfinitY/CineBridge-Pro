...
class ReportGenerator:
    ...
    def generate_pdf(dest_path, file_data_list, project_name="Unnamed Project"):
        ...
        html += f"""
            ...
            <div class="footer">CineBridge Pro v4.16.2 - Professional DIT & Post-Production Suite</div>
        </body>
        </html>
        """
...
class AboutDialog(QDialog):
    def __init__(self, parent=None):
        ...
        version = QLabel("v4.16.2"); version.setStyleSheet("font-size: 14px; color: #888;"); version.setAlignment(Qt.AlignmentFlag.AlignCenter); layout.addWidget(version)
# ...
